...
{{< admonition type="admonition" title="Getting Started Checklist" class="tip" >}}
## Before the first class and into the first week

**Read the administrative documents on the course website or linked in D2L.**

Most importantly:
* make sure you can log into [D2L](https://d2l.msu.edu/d2l/login) and that you can find the course page,
* read about your [teachers](/course-information/teachers/) and the [grading policy](/course-information/grading/), 
* review the [textbook information](/course-information/textbooks/) and make sure you have [access to the books](https://github.com/mhjensen/Physics321/tree/master/doc/Literature), 
* look over the [schedule](/logistics-resources/schedule-cal/) and let Danny (<caball14@msu.edu>) know if you have any conflicts.
...
{{< admonition type="important" title="* There is far too much material for you to review and read in a given week." >}}
...
Look at [Week 1](/course-materials/01_notes/) for an example of what to expect.
...
These check-ins will be graded for completion only and factor into your reflection grade. They will be due before Monday's classes and available on [D2L](https://d2l.msu.edu/d2l/login).
...
How to [setup iClickers](/logistics-resources/iclicker-setup/).


### 🙋 RaiseMyHand

Danny has developed an anonymous question and comment tool called [RaiseMyHand](https://dannycaballero.info/teaching/tools/raisemyhand/). We’ll use it in class so you can ask questions, share feedback, and flag anything that’s unclear—completely anonymously. If you see a question you also have, you can upvote it so we know what to address first.

If you run into bugs or have feature ideas, please submit them as [GitHub issues](https://github.com/OER-Forge/raisemyhand/issues). The repository is here: <https://github.com/OER-Forge/raisemyhand>


[![Report Issues](https://img.shields.io/badge/report%20issues-GitHub-blue)](https://github.com/OER-Forge/raisemyhand/issues)
[![GitHub Issues](https://img.shields.io/github/issues/OER-Forge/raisemyhand)](https://github.com/OER-Forge/raisemyhand/issues)
...
More details on homework assignments can be found on the [assignments overview page](/course-materials/assignment-overview/).
...
{{< admonition type="admonition" title="Homework Submission" >}}
You will submit Exercise 0 on [D2L](https://d2l.msu.edu/d2l/login).

You will submit the rest of your homework assignment on [Gradescope](https://www.gradescope.com/).

How to [submit your homework on Gradescope](/logistics-resources/gradescope-submissions/).
{{< /admonition >}}
...
These reflections will be graded for completion only and factor into your reflection grade. They will be posted on [D2L](https://d2l.msu.edu/d2l/login) along with Exercise 0.
...
{{< admonition type="admonition" title="Midterm Collaboration and Guidelines" class="tip" >}}
...
{{< admonition type="admonition" title="Final Project Partners" class="tip" >}}
