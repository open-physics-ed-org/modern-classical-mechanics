...
When we define [Classical Mechanics](https://en.wikipedia.org/wiki/Classical_mechanics), at least for the purposes of undergraduate study, we will define it as **the physics of large, slow, mechanical systems**.
...
{{< figure src="/images/vector-graphics/block_on_ramp_sliding_fbd.png" caption="Free Body Diagram of Box on a Inclined Ramp; the arrows label the direction of forces acting on the box. [SVG File](../images/vector-graphics/block_on_ramp_sliding_fbd.svg)" >}}
...
$$\vec{F}_{net} = \vec{f}_k + \vec{N} + \vec{F}_{gravity} = 0$$

$$\sum F_{x,i} = f_k - mg\sin(\theta) = 0$$
...
{{< admonition type="admonition" title="Check" >}}
...
{{< /admonition >}}
{{< admonition type="tip" title="A few things to note about this problem:" >}}
...
{{< figure src="/images/vector-graphics/falling_ball_drag_fbd_dynamics.png" caption="Free Body Diagram of Falling Object; the arrows label the direction of forces acting on the object. [SVG File](../images/vector-graphics/falling_ball_drag_fbd_dynamics.svg)" >}}
...
{{< admonition type="tip" title="A few things to note:" >}}
