...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Vector in Two Dimensions; the vector is defined by its magnitude, A, and its direction, \textbackslash theta}]{../images/02_notes_2dvector.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Dot Product of Two Vectors; the dot product is the product of the magnitudes of the vectors and the cosine of the angle between them}]{../images/02_notes_Dot-product.png}}
