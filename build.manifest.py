...
def main():
    ...
    if getattr(args, 'jupyter', False):
        ...
        # Build the Jupyter Book HTML site into a temp dir to avoid nested _build/html/_build/html
    ...
    # Use _toc.yml for notebook order (generated by preprocess_content_yml.py)
